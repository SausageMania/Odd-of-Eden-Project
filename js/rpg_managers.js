...
/*
    JSON 파일이 매번 게임 실행/저장시
    덮어씌워지므로 JSON 파일 직접 수정은 의미가 없음
    따라서 plainText 를 TextManager가 return 하는
    함수를 만들 것
...
Object.defineProperties(TextManager, {
    ...
    gameEndFrealFreal : TextManager.getter('command', 10),
    // (게임 종료 메뉴에서) 실제 종료 기능 추가 2020.01.06. staticccast
    autoSaveSlot    : TextManager.getter('command', 17),
    // 자동저장 슬롯 텍스트 - Window_SavefileList.prototype.drawFileId
