...
//  키 입력 - input 매핑 2020.01.06. staticccast
//  대소문자 알아서 구분없이 받아들임
//  ASCII 값
Input.keyMapper = {
    9: 'tab',       // tab
    ...
    40: 'down',     // down arrow
    45: 'escape',   // insert
    67: 'endgamemenu',   // C (종료/옵션 메뉴) 추가 2020.01.06. staticccast
 ...
 * @type Object
 */
// 게임 패드 - input 매핑 그러나 게임패드를 지원해야하나? 2020.01.06. staticccast
Input.gamepadMapper = {
    0: 'ok',        // A
    1: 'cancel',    // B
    2: 'shift',     // X
...
/*
    마우스 휠 클릭으로 손전등 Toggle On/Off
    2020.02.20. staticccast    
*/
    if($gameSwitches.value(22)) //22번 스위치(gotFlash) on 일 경우
    {
